(function () {
  ...
  window.__BRAND__ = {
    ...
    reel: {
      ...
      /* El mismo tramo en 9:16 (608x1080) para pantallas verticales.
         Se recorto del master 1080p toma por toma, siguiendo a la gente;
         el horizontal en un celular se veria recortado a un tercio. */
      loopVertical: "assets/video/reel-loop-vertical.mp4",

      /* foto mientras carga el loop (la vertical va en el <picture>) */
